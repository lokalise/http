...
/**
 * Class for execution of HTTP POST/GET requests
 *
 * @author    Vladimir Bashkirtsev <vladimir@bashkirtsev.com>
 * @copyright 2013-2016 Vladimir Bashkirtsev
 * @license   https://opensource.org/licenses/MIT MIT License
 * @version   SVN: $Date: 2016-10-03 00:37:23 +0000 (Mon, 03 Oct 2016) $ $Revision: 12 $
 * @link      $HeadURL: https://open.logics.net.au/foundation/HTTP/tags/0.1.4/src/HTTPclient.php $
 *
 * @untranslatable Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.2.12) Gecko/20101026 Firefox/3.6.12 GTB7.1 ( .NET CLR 3.5.30729; .NET4.0E)
 */
